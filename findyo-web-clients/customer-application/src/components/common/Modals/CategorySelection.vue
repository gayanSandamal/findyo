  ...
  <div class="category-selection-modal-container flex v-center h-center">
    ...
    <div class="box-nue category-selection-modal">
      <div class="full-width m-b-1">
        <h3 class="title">Select a category</h3>
      </div>
      <div class="full-width m-b-1">
      ...
      <div class="full-width m-b-1">
       <CategoriesList :list="list" class="first-category-selection-frame"/>
      </div>
...
export default {
  ...
  components: {
    CategoriesList: () => import('@/components/common/Lists/CategoriesList'),
  ...
  methods: {
    ...
    removeModal() {
      this.$set(this.isCategorySelectModal, 'state', false)
    },
    clearSelected() {
      this.list.map(o => {
        this.$set(o, 'selected', false)
