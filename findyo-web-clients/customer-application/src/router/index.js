...
const routes = [
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "ChatBox"*/ './../components/common/ChatBox.vue'
          ),
      },
    ],
  },
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "PrivacyandPolicy"*/ '../views/PrivacyandPolicy.vue'
      ),
  },
  {
    path: '/settings/',
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "ProfileSettings"*/ './../components/settings/ProfileSettings.vue'
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "SecuritySettings"*/ './../components/settings/SecuritySettings.vue'
          ),
      },
    ],
  },
  {
    ...
    name: 'post',
    component: () =>
      import(/* webpackChunkName: "PostPage"*/ '../views/PostPage.vue'),
  },
  {
    path: '/completion',
    name: 'completion',
    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "Timeline"*/ './../components/feed/Timeline.vue'
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "Portfolio"*/ './../components/feed/Portfolio.vue'
          ),
      },
    ],
  },
...
router.beforeEach((to, from, next) => {
  ...
  const isRequiredProfileCompletion = to.matched.some(
    (record) => record.meta.isRequiredProfileCompletion
  );
  if (userLoggedIn) {
